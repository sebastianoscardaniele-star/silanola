...
const STORAGE_KEY = 'panini-jugadores-directo-ok-v5';
...
function getPlayerName(sectionCode, number, fallback = '') {
  return PLAYER_PRESETS[sectionCode]?.[Number(number) - 1] || fallback || '';
}
...
function buildAlbum() {
  ...
  const countries = TEAMS.map(team => ({
    ...
    stickers: Array.from({ length: 20 }, (_, index) => ({
      ...
      number: index + 1,
      player: getPlayerName(team.code, index + 1),
      have: false,
      duplicates: 0
    }))
  }));
    ...
    <div className="page">
      ...
      <section className="help-section">
        <div className="help-hero">
          <div>
            <div className="calendar-kicker">Guía rápida</div>
            <h2>Cómo usar la aplicación</h2>
            <p>Aprendé qué hace cada sección, botón y filtro para llevar tu álbum de forma ordenada.</p>
          </div>
        </div>

        <div className="help-grid">
          <article className="help-card">
            <h3>Álbum de figuritas</h3>
            <p>Es la pantalla principal para controlar tus figuritas por selección, grupos y especiales.</p>
            <ul>
              <li><strong>Tengo / Falta:</strong> marca si ya tenés la figurita o si todavía te falta.</li>
              <li><strong>Jugador:</strong> muestra el nombre cargado para esa figurita.</li>
              <li><strong>Repetidas:</strong> usá <strong>+</strong> y <strong>-</strong> para indicar cuántas tenés para intercambiar.</li>
            </ul>
          </article>

          <article className="help-card">
            <h3>Grupos</h3>
            <p>Las tarjetas de grupos muestran las selecciones y el avance de cada grupo.</p>
            <ul>
              <li>Al tocar un grupo se filtran las figuritas de ese grupo.</li>
              <li>La barra indica el porcentaje completado.</li>
              <li><strong>Especiales</strong> agrupa FWC y CC.</li>
            </ul>
          </article>

          <article className="help-card">
            <h3>Filtros</h3>
            <p>Sirven para encontrar rápido lo que necesitás.</p>
            <ul>
              <li><strong>Buscar:</strong> buscá país, código, grupo o jugador.</li>
              <li><strong>Todos los grupos:</strong> filtra por grupo A-L o Especiales.</li>
              <li><strong>Todas las secciones:</strong> muestra una selección específica.</li>
              <li><strong>Tengo / Faltantes / Repetidas:</strong> muestra figuritas según estado.</li>
              <li><strong>Vista compacta:</strong> cambia entre tarjetas grandes y vista resumida.</li>
            </ul>
          </article>

          <article className="help-card">
            <h3>Calendario de partidos</h3>
            <p>Es una sección separada para consultar el fixture.</p>
            <ul>
              <li>Muestra fase, fecha, partido, grupo/cruce, horarios y sede.</li>
              <li>Podés buscar por equipo, sede, grupo o fase.</li>
              <li>También podés filtrar por fase del torneo.</li>
            </ul>
          </article>

          <article className="help-card">
            <h3>Guardado automático</h3>
            <p>La app guarda tu avance en el navegador.</p>
            <ul>
              <li>Se guardan figuritas marcadas, repetidas, filtros y vista.</li>
              <li>Si usás otro navegador o dispositivo, los datos no se transfieren automáticamente.</li>
              <li>Si Vercel muestra datos viejos, probá en incógnito o limpiá localStorage.</li>
            </ul>
          </article>

          <article className="help-card">
            <h3>Uso recomendado</h3>
            <p>Para usarla más rápido:</p>
            <ul>
              <li>Marcá primero todas las figuritas que ya tenés.</li>
              <li>Cargá repetidas con el botón <strong>+</strong>.</li>
              <li>Usá <strong>Faltantes</strong> para saber qué buscar.</li>
              <li>Usá <strong>Repetidas</strong> para organizar intercambios.</li>
            </ul>
          </article>
        </div>
      </section>
                  ...
                  <article className={sticker.have ? 'sticker owned' : 'sticker'} key={sticker.id}>
                    ...
                    {section.type === 'team' && (
                      <label className="player-field">
                        Jugador
                        <input
                          value={getPlayerName(section.code, sticker.number, sticker.player)}
