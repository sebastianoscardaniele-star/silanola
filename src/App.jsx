    ...
    <div className="page">
      <header className="hero">
        <div className="hero-copy">
          ...
          <p>Gestioná tus faltantes, repetidas y nombres de jugadores con una interfaz visual por grupos.</p>
        </div>
      ...
      <section className="actions">
        ...
        <button onClick={() => setShowImport(!showImport)}>Importar JSON</button>
      ...
      {showImport && (
        <section className="import-card">
          ...
          <textarea value={importText} onChange={event => setImportText(event.target.value)} placeholder="Pegá acá tu JSON exportado..." />
          <button onClick={importAlbum}>Importar ahora</button>
        </section>
      )}
